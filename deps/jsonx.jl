# Copied from:
# https://github.com/JuliaIO/JSON.jl/tree/3f7d15f6d6acb54a1abfa10abd8fcad9509be908/vendor

module JSONX

## Begin custom changes

# Note: this also required modification of `write_json()` to support JSONText
struct JSONText
    text::String
end

function print_dict(io::IO, dict::AbstractDict)
    print(io, '{')
    first = true
