...
const ipy_mime = [ "application/vnd.dataresource+json", "application/vnd.vegalite.v2+json", "text/html", "text/latex", "image/svg+xml", "image/png", "image/jpeg", "text/plain", "text/markdown", "application/javascript" ]
